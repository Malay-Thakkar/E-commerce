...
from cart.views import cart_add,cart_delete,cart_summary,cart_update,wishlist_summary, wishlist_add, wishlist_delete,CartAddAPIView, WishlistAddAPIView, CartSummaryAPIView, CartDeleteAPIView, CartUpdateAPIView, ProductSearchAPIView, ComplexSearchAPIView
...
urlpatterns = [
    ...
    path('api/complex/search', ComplexSearchAPIView.as_view(), name='api_complex_search'),
]